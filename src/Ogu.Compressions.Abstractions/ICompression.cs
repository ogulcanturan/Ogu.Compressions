...
namespace Ogu.Compressions.Abstractions
{
    ...
    public interface ICompression
    {
        ...
        /// </summary>
        /// <param name="stream">The stream to compress.</param>
        /// <param name="streamPosition">Position of the stream.</param>
        /// <param name="cancellationToken">A token to cancel the operation.</param>
        /// <returns>A task that represents the asynchronous compression operation, which wraps the <see cref="byte" /> array containing the compressed data.</returns>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        Task<byte[]> CompressAsync(Stream stream, StreamPosition streamPosition, CancellationToken cancellationToken = default);
        ...
        /// <returns>A task that represents the asynchronous compression operation, which wraps the <see cref="byte" /> array containing the compressed data.</returns>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        Task<byte[]> CompressAsync(Stream stream, StreamPosition streamPosition, bool leaveOpen, CancellationToken cancellationToken = default);
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        Task<byte[]> CompressAsync(Stream stream, CompressionLevel level, StreamPosition streamPosition, CancellationToken cancellationToken = default);
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        Task<byte[]> CompressAsync(Stream stream, CompressionLevel level, StreamPosition streamPosition, bool leaveOpen, CancellationToken cancellationToken = default);
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        Task<Stream> CompressToStreamAsync(Stream stream, StreamPosition streamPosition, CancellationToken cancellationToken = default);
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        Task<Stream> CompressToStreamAsync(Stream stream, StreamPosition streamPosition, bool leaveOpen, CancellationToken cancellationToken = default);
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        Task<Stream> CompressToStreamAsync(Stream stream, CompressionLevel level, StreamPosition streamPosition, CancellationToken cancellationToken = default);
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        Task<Stream> CompressToStreamAsync(Stream stream, CompressionLevel level, StreamPosition streamPosition, bool leaveOpen, CancellationToken cancellationToken = default);
        ...
        /// <returns>A <see cref="byte" /> array containing the compressed data.</returns>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        byte[] Compress(Stream stream, StreamPosition streamPosition);
        ...
        /// <returns>A <see cref="byte" /> array containing the compressed data.</returns>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        byte[] Compress(Stream stream, StreamPosition streamPosition, bool leaveOpen);
        ...
        /// <returns>A <see cref="byte" /> array containing the compressed data.</returns>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        byte[] Compress(Stream stream, CompressionLevel level, StreamPosition streamPosition);
        ...
        /// <returns>A <see cref="byte" /> array containing the compressed data.</returns>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        byte[] Compress(Stream stream, CompressionLevel level, StreamPosition streamPosition, bool leaveOpen);
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        Stream CompressToStream(Stream stream, StreamPosition streamPosition);
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        Stream CompressToStream(Stream stream, StreamPosition streamPosition, bool leaveOpen);
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        Stream CompressToStream(Stream stream, CompressionLevel level, StreamPosition streamPosition);
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        Stream CompressToStream(Stream stream, CompressionLevel level, StreamPosition streamPosition, bool leaveOpen);
        ...
        /// <returns>A task that represents the asynchronous decompression operation, which wraps the <see cref="byte" /> array containing the decompressed data.</returns>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        Task<byte[]> DecompressAsync(Stream stream, StreamPosition streamPosition, CancellationToken cancellationToken = default);
        ...
        /// <returns>A task that represents the asynchronous decompression operation, which wraps the <see cref="byte" /> array containing the decompressed data.</returns>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        Task<byte[]> DecompressAsync(Stream stream, StreamPosition streamPosition, bool leaveOpen, CancellationToken cancellationToken = default);
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        Task<Stream> DecompressToStreamAsync(Stream stream, StreamPosition streamPosition, CancellationToken cancellationToken = default);
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        Task<Stream> DecompressToStreamAsync(Stream stream, StreamPosition streamPosition, bool leaveOpen, CancellationToken cancellationToken = default);
        ...
        /// <returns>A <see cref="byte" /> array containing the decompressed data.</returns>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        byte[] Decompress(Stream stream, StreamPosition streamPosition);
        ...
        /// <returns>A <see cref="byte" /> array containing the decompressed data.</returns>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="stream"/> is <c>null</c>.</exception>
        byte[] Decompress(Stream stream, StreamPosition streamPosition, bool leaveOpen);
    }
}