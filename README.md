...
| **[Ogu.Compressions.Brotli](https://github.com/ogulcanturan/Ogu.Compressions/tree/master/src/Ogu.AspNetCore.Compressions.Brotli)** | Brotli (Google) compression. Uses the built-in API if the target is newer than .NET Standard 2.0, it falls back to the [Brotli.NET](https://github.com/XieJJ99/brotli.net) third-party library. |
